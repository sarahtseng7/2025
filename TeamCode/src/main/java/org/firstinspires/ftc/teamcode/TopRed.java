...
@Autonomous(name="Pushbot: Top Red", group="Pushbot")
//@Disabled
public class TopRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        strafe(DRIVE_SPEED, 10, -10, -10, 10, 10); //strafe to the left ~1sq
        encoderDrive(DRIVE_SPEED, 10, 10, 10); //move forward towards shipping hub ~1sq
        ...
        strafe(DRIVE_SPEED, 10, -10, -10, 10, 10); //strafe left over to the storage unit
        encoderDrive(DRIVE_SPEED, 10, 10, 10); //park into the storage unit ~0.5sq forwards
        encoderDrive(DRIVE_SPEED, -10,-10, 10); //drive backwards ~0.5sq
        encoderDrive(DRIVE_SPEED, 10, -10, 10); //turn right 90 degrees
        encoderDrive(DRIVE_SPEED, 10, 10, 10); //drive into the warehouse
